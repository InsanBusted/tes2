...
CREATE TABLE `paramedik` (
  ...
  `kategori` enum('Dokter Hati','Dokter Gigi','Dokter Kulit','') DEFAULT NULL,
...
(1, 'Hosting3', 'Hosting', 'DPK', '2004-05-04', '1', 'testing@gmail.com', 'Sugutamu Raya Jln Hj Sholihin', 1);
...
(1, 'Rumah Sakit Citra Arafiq'),
(2, 'Rumah Sakit Brimob');
...
ALTER TABLE `periksa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pasien_id` (`pasien_id`,`dokter_id`),
